    ...
    return(
        <ImageBackground source={require("../assets/images/pexels-photo-326268.jpeg")} style={styles.image}>
            <View style={{width:'100%', justifyContent:'center', alignItems:'center'}}>
                <Text style={{color:'white', fontSize:30, fontWeight:'bold', padding:10, fontFamily:'Anton-Regular'}}>Login</Text>
            ...
            <View style={{width:'100%'}}>
                ...
                <View style={{flexDirection:'row', justifyContent:"center", alignItems:"center"}}>
                    ...
                    onPress={()=>{
                        ...
                        <Text style={{color:"white", margin:10, fontSize:18, fontFamily:'Anton-Regular', fontWeight:'bold'}}>Rgister</Text>
                    </TouchableOpacity>
                    <TouchableOpacity>
